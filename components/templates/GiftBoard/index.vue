...
<template>
  <section id="giftbox" class="gift-board text-center p-6 mt-6">
    ...
    <div
      class="flex flex-col items-center justify-center space-y-6 md:space-y-0 md:flex-row md:space-x-12 mt-6"
    >
